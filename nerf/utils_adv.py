...
class Trainer(object):
    ...
    def train_step(self, data):
        ...
        # stage 1
            ...
            outputs = self.model.render_stage1(rays_o, rays_d, ifrandom, mvp, H, W, index=index, bg_color=bg_color, shading=shading, **vars(self.opt))
            pred_rgb = outputs['image']
    ...
    def eval_step(self, data):
        ...
        if self.opt.stage > 0:
            mvp = data['mvp'].squeeze(0) # [4, 4]
            outputs = self.model.render_eval_stage1(rays_o, rays_d, mvp, H, W, index=index, bg_color=bg_color, shading=shading, **vars(self.opt))
        else:    
